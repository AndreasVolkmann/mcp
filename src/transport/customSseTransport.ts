 ...
 * 
 * Added fallback to absolute url for backwards compatibility.
 */
export class CustomSseServerTransport implements Transport {
  private readonly _sessionId: string;
  private readonly _useAbsoluteUrl: boolean;
  ...
  async start(): Promise<void> {
    ...
    const endpoint = this._useAbsoluteUrl
      ? `${encodeURI(this._endpoint)}?sessionId=${this._sessionId}`
      : relativeUrlWithSession
